...
Factor Pricing Model Universe could always use more documentation, whether as part of the official Factor Pricing Model Universe docs, in docstrings, or even on the web in blog posts, articles, and such.
...
2. Clone your fork locally:
   ...
   ```shell
   $ git clone git@github.com:your_name_here/factor-pricing-model-universe.git
   ```
